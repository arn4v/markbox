...
export function Folder(props) {
  const { id, index, edit: globalEdit } = props;
                      ...
                      <motion.span
                        ...
                        <>
                          <button
                            ...
                            className="p-1 duration-150 ease-in-out rounded-full dark:hover:bg-blueGray-600 focus:outline-none"
                            disabled={showEdit}>
                            <HiPencil className="w-4 h-4" />
                          </button>
                          <button
                            onClick={enterDeleteMode}
                            className="p-1 transition duration-150 ease-in-out rounded-full dark:hover:bg-blueGray-600 focus:outline-none"
                            disabled={showDelete}>
